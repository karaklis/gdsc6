...
def preprocess_data_for_training(
    ...
    """
    Preprocesses audio d for training.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_dataset_mean", type=float, default=None)                  # mean value of spectrograms of our d
    parser.add_argument("--train_dataset_std", type=float, default=None)                   # standard deviation value of spectrograms of our resampled d
    ...
    parser.add_argument("--data_channel", type=str, default=os.environ["SM_CHANNEL_DATA"]) # directory where input d from S3 is stored
    parser.add_argument("--train_dir", type=str, default="train")                          # folder name with training d
    parser.add_argument("--val_dir", type=str, default="val")                              # folder name with validation d
    parser.add_argument("--test_dir", type=str, default="test")                            # folder name with test d
