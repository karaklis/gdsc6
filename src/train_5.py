...
class CFG:
    ...
    phase = 'train'  # 'pretrain', 'train', 'predict'
    pretrain_mode = False
    pretrain_labels = 10
    verbose = 1
    ...
    time_long = 2.4             # long time window, taken from original signal
    time_focus = 0.5            # focus point within long time window
    time_step = 2.4             # time offset step forward for splitting up longer recordings
